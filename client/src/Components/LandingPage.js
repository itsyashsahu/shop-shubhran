...
import { deleteShop } from "./Content";
  ...
  return searchLoader ? (
    ...
    >
      ...
      <div className="d-flex justify-content-center column ">
        <Card
          style={{ width: "48rem" }}
          className="m-3 shadow p-3 mb-3 bg-white rounded"
        >
          <Card.Body style={{ boxShadow: "5px 5px 5px grey", display: "flex" }}>
            <div className="w-85" style={{ textAlign: "center" }}>
              ...
              >
                Welcome to Shop Aisle
              </Card.Title>
              <Card.Subtitle
                className="mt-2 mb-3 text-muted"
                style={{ fontSize: "1.3rem" }}
              >
                Dear user, Welcome to Shop Aisle. Shop Aisle is created with the
                aim of cooperation between you and your fellow people. You can
                list shops which you found good, see what other shops people
                have added. Enjoy a complete list of shops that you found or
                which other people have added. Get benefits and give benefits.
                Contact creators of shop through there e-mail id's for a better
                description of shop.
