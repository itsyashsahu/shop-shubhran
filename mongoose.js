...
const connString =
  "mongodb+srv://shubhrant:luucent0@cluster0.feny1.mongodb.net/shop_aisle?retryWrites=true&w=majority";
const connString1 =
...
const addShop = async (req, res, next) => {
  ...
  const result = await newShop.save().catch((err) => console.log(err));
  // console.log("this is uaseraslkdfjasdlkj ", newShop, result);
  res.json(result);
};
